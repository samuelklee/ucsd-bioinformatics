...
public class CyclopeptideScoring {
    public static int getCyclicScore(List<Integer> peptide, List<Integer> spectrum) {
        List<Integer> theoreticalSpectrum = CyclopeptideSequencing.getCyclicSpectrum(peptide);
    ...
    public static String doWork(String dataFileName) {
        try (BufferedReader br = new BufferedReader(new FileReader(dataFileName))) {
            ...
            int score = getCyclicScore(peptide, spectrum);
    ...
    public static void main(String[] args) throws IOException {
        String result = doWork("src/test/resources/IandII/dataset_102_3.txt");
